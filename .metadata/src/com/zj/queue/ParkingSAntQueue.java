...
public class ParkingSAntQueue extends QueueFather{
	private  Logger log = Logger.getLogger(ParkingSAntQueue.class);
	/**
	 * 队列容器
	 * 其中存储的为
	 */
	...
	public  void init(QueueBean queueBean,String listName2,boolean flag)
	{
		...
		String url="";
		try{
		url = AntGetUrl.doGet("http://www.bjjtgl.gov.cn/publish/portal0/tab100/","gbk");
		}catch(Exception e)
		{
			log.error(e);
			e.printStackTrace();
	...
	{
		return (JobsInputQueueBean)getQueueBean(bean,info,JobsInputQueueBean.class,log,"51job  地铁周边 人群队列信息为空");
	}
	/**
	 * 添加内容
	 * @param bean
