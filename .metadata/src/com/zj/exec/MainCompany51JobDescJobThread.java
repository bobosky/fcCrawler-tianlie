...
public class MainCompany51JobDescJobThread implements Runnable{
	...
	public MainCompany51JobDescJobThread(QueueBean queueBean)
	{
...
//		System.out.println(queueBean.getQueueOutputName()+"\t"+queueBean.isAllWriteRun());
		...
		Company51JobDescJobExecThread execThread=new Company51JobDescJobExecThread(queueBean,queue,intoDb);
