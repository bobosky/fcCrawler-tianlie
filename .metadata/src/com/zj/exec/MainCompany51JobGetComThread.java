...
public class MainCompany51JobGetComThread implements Runnable{
	...
	public MainCompany51JobGetComThread(QueueBean queueBean)
	{
	...
	public void run()
	{
		...
		Company51JobGetComExecThread execThread=new Company51JobGetComExecThread(queueBean,queue,intoDb);
