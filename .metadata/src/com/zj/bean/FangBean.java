...
public class FangBean implements Serializable{
	
	/**
	 * 列表页写字楼的信息
	 */
	FangInputQueueBean FangListc=null;
	...
	public FangInputQueueBean getFangListc() {
		return FangListc;
	}
	public void setFangListc(FangInputQueueBean fangListc) {
		FangListc = fangListc;
	}
	...
	public void setFangCode(String fangCode) {
