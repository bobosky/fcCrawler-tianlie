...
public class Company51JobDescJobExecThread implements Runnable{
	 ...
	 * 初始化程序
	 */
	public Company51JobDescJobExecThread(QueueBean queueBean,Company51JobDescJobAntQueue queue,IntoDb intoDb)
	{
		this.queue=queue;
		this.intoDb=intoDb;
	...
	public void run()
	{
		...
		while(true)
		{
			...
			Company51JobPositionBean bean=queue.get(queueBean);
			if(bean==null)
			{
				continue;
			}
