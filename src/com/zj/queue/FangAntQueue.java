...
public class FangAntQueue extends QueueFather{
	...
	public  void init(QueueBean queueBean,String listName2,boolean flag)
	{
		...
		info=new LinkedBlockingQueue<FangInput2QueueBean>(queueBean.getInputQueueNum());
...
//	}
	...
	{
		return (FangInput2QueueBean)getQueueBean(bean,info,FangInput2QueueBean.class,log,"搜房队列信息为空");
	}
	/**
	 * 添加内容
	 * @param bean
