...
public class DianpingBusinessAreaExecThread implements Runnable{
	 ...
	 * 初始化程序
	 */
	public DianpingBusinessAreaExecThread(QueueBean queueBean,QueueBean queueFirstBean,DianpingBusinessAreaAntQueue queue,IntoDb intoDb)
	{
	...
	public void run()
	{
		...
		while(true)
		{
			...
			BussinessAreaPageBean bean=null;
