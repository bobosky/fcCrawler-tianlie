...
public class MainParkingThread implements Runnable{
	...
	public MainParkingThread(QueueBean queueBean,QueueBean queueFirstBean)
	{
	...
	public void run()
	{
		...
		ParkingExecThread execThread=new ParkingExecThread(queueBean,queueFirstBean,queue,intoDb);
