...
public class MainCompanyZhaopinGetComThread implements Runnable{
	...
	public MainCompanyZhaopinGetComThread(QueueBean queueBean,QueueBean queueFirstBean)
	{
	...
	public void run()
	{
		...
		CompanyZhaopinGetComExecThread execThread=new CompanyZhaopinGetComExecThread(queueBean,queueFirstBean,queue,intoDb);
