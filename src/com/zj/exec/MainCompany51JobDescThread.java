...
public class MainCompany51JobDescThread implements Runnable{
	...
	public MainCompany51JobDescThread(QueueBean queueBean,QueueBean queueBeanFirst)
	{
	...
	public void run()
	{
		...
		Company51JobDescExecThread execThread=new Company51JobDescExecThread(queueBean,queueBeanFirst,queue,intoDb,intoDb2);
