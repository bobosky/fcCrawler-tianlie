...
public class MainSubwayAndBusThread implements Runnable{
	...
	public MainSubwayAndBusThread(QueueBean queueBean,QueueBean queueFirstBean)
	{
	...
	public void run()
	{
		...
		SubwayAndBusExecThread execThread=new SubwayAndBusExecThread(queueBean,queueFirstBean,queue,intoDb);
