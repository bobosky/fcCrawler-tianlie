...
public class MainBusAndStationThread implements Runnable{
	...
	public MainBusAndStationThread(QueueBean queueBean,QueueBean queueFirstBean)
	{
	...
	public void run()
	{
		...
		BusAndStationExecThread execThread=new BusAndStationExecThread(queueBean,queueFirstBean,queue,intoDb);
