...
public class MainCompanyZhaopinThread implements Runnable{
	...
	public MainCompanyZhaopinThread(QueueBean queueBean,QueueBean queueFirstBean)
	{
	...
	public void run()
	{
		...
		CompanyZhaopinExecThread execThread=new CompanyZhaopinExecThread(queueBean,queueFirstBean,queue,intoDb);
